...
def test_process_video_integration_success(client):
    ...
    data = {"interval": 5}  # Use um intervalo pequeno para garantir extração de frames

    # Dispare a requisição para o endpoint de processamento
    response = client.post("/api/process-video", files=files, data=data)
    # Verifique o status e a mensagem de sucesso
    ...
    # Opcional: Verifique se o file_url tem o formato esperado
